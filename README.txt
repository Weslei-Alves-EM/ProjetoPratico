...
Ferramenta para administração de banco de dados: DBeaver Community
Tecnologias
...
Abra o projeto no Visual Studio Community 2022.
Configure o banco de dados Firebird usando o DBeaver ou outra ferramenta de sua escolha.
Execute o projeto e explore as funcionalidades do sistema.
Contribuição
